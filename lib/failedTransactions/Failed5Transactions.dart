...
class Failed5Transactions extends StatefulWidget {
  const Failed5Transactions({Key key}) : super(key: key);

  @override
  _Failed5TransactionsState createState() => _Failed5TransactionsState();
}

class _Failed5TransactionsState extends State<Failed5Transactions> {
  ...
  fetchFailedTransaction() async {
    var response = await http.get(Uri.https("jaysharma8.000webhostapp.com",
        "getLast5BankUserFailedTransactions.php"));
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Last 5 Failed Transactions"),
          centerTitle: true,
        ),
        body: Column(
          children: [
